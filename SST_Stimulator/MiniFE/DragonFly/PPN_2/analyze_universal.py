...
STUDY    = "MiniFE_Dragonfly_PPN2"
TOPOLOGY = "other"
# (x-axis label, dims tuple, csv filename)
RUNS = [
    ("4",  (2, 2),  "dragonfly_4_ppn2_nodes8_stats.csv"),
    ("16", (4, 4),  "dragonfly_16_ppn2_nodes32_stats.csv"),
    ("64", (8, 8),  "dragonfly_64_ppn2_nodes128_stats.csv"),
]
# -------------------------------------------------------------------------
