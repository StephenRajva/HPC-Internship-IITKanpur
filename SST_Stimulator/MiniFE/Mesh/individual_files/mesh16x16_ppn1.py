...
# =====================================================================
#  Mesh 16x16  -  PPN (MPI ranks per node) FIXED at 1
#  nodes = 256  (routers 256 x local_ports 1)
#  ranks = 256  -> ranks == nodes  => PPN = 1
# =====================================================================
...
sst.setStatisticOutput("sst.statOutputCSV", {
    "filepath": "mesh_16x16_ppn1_stats.csv",
    "separator": ", "
})
