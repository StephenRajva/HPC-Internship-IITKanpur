...
STUDY    = "MiniFE_Torus"      # used in titles + output filenames
TOPOLOGY = "torus"
# (x-axis label, dims tuple, csv filename)
RUNS = [
    ("2x2",   (2, 2),   "torus_2x2_ppn1_nodes4_stats.csv"),
    ("4x4",   (4, 4),   "torus_4x4_ppn1_nodes16_stats.csv"),
    ("8x8",   (8, 8),   "torus_8x8_ppn1_nodes64_stats.csv"),
    ("16x16", (16, 16), "torus_16x16_ppn1_nodes256_stats.csv"),
    ("32x32", (32, 32), "torus_32x32_ppn1_nodes1024_stats.csv"),
]
# -------------------------------------------------------------------------
