#!/usr/bin/env python
# =============================================================================
#  torus_ppn1.py  -  MiniFE on a Torus, PPN (ranks per node) = 1
# =============================================================================
#  Same study as the MiniFE mesh, but topoTorus (wraparound links).
#  PPN = ranks / nodes = size / (routers * local_ports). We set size = nodes,
#  so PPN is ALWAYS 1.
#
#  USAGE:  export MESH_SHAPE="4x4"   (then) sst torus_ppn1.py
...
# MiniFE motifs (identical to the mesh study so the comparison is fair)
motifs = [
