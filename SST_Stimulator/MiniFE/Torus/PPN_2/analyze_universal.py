...
STUDY    = "MiniFE_Torus_PPN2"
TOPOLOGY = "torus"
# (x-axis label, dims tuple, csv filename)
RUNS = [
    ("2x2",   (2, 2),   "torus_2x2_ppn2_nodes8_stats.csv"),
    ("4x4",   (4, 4),   "torus_4x4_ppn2_nodes32_stats.csv"),
    ("8x8",   (8, 8),   "torus_8x8_ppn2_nodes128_stats.csv"),
    ("16x16", (16, 16), "torus_16x16_ppn2_nodes512_stats.csv"),
    ("32x32", (32, 32), "torus_32x32_ppn2_nodes2048_stats.csv"),
]
# -------------------------------------------------------------------------
