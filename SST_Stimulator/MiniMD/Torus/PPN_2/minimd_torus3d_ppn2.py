#!/usr/bin/env python
# =============================================================================
#  minimd_torus3d_ppn2.py  -  MiniMD on a 3D Torus, PPN (ranks per node) = 2
# =============================================================================
#  Same study as minimd_torus3d_ppn1.py but 2 hosts per router -> PPN = 2.
#  Router grid (shape) stays the same as PPN=1; nodes & ranks double.
#  PPN = ranks / routers = (2 * routers) / routers = 2.
#
#  USAGE:  export MESH_SHAPE="4x4x4"   (then) sst minimd_torus3d_ppn2.py
# =============================================================================
import sst, os
...
# MiniMD motifs (identical to PPN=1 MiniMD runs)
motifs = [
...
print("==================================================")
print(f" Topology          : 3D Torus {shape} - MiniMD")
