...
STUDY    = "MiniMD_Mesh3D_PPN2"
TOPOLOGY = "mesh"
# (x-axis label, dims tuple, csv filename)
RUNS = [
    ("2x2x2", (2,2,2), "minimd_mesh_2x2x2_ppn2_nodes16_stats.csv"),
    ("2x2x4", (2,2,4), "minimd_mesh_2x2x4_ppn2_nodes32_stats.csv"),
    ("4x4x4", (4,4,4), "minimd_mesh_4x4x4_ppn2_nodes128_stats.csv"),
    ("4x4x8", (4,4,8), "minimd_mesh_4x4x8_ppn2_nodes256_stats.csv"),
    ("8x8x8", (8,8,8), "minimd_mesh_8x8x8_ppn2_nodes1024_stats.csv"),
]
# -------------------------------------------------------------------------
