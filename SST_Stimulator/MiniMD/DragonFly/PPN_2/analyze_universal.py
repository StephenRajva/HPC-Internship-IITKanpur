...
STUDY    = "MiniMD_Dragonfly_PPN2"
TOPOLOGY = "other"
# (x-axis label, dims tuple, csv filename)
RUNS = [
    ("4",  (2, 2),  "minimd_dragonfly_4_ppn2_nodes8_stats.csv"),
    ("16", (4, 4),  "minimd_dragonfly_16_ppn2_nodes32_stats.csv"),
    ("64", (8, 8),  "minimd_dragonfly_64_ppn2_nodes128_stats.csv"),
]
# -------------------------------------------------------------------------
