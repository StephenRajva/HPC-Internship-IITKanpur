...
STUDY    = "MiniMD_Dragonfly"      # used in titles + output filenames
TOPOLOGY = "other"
# (x-axis label, dims tuple, csv filename)
RUNS = [
    ("4",  (0,), "minimd_dragonfly_4_ppn1_nodes4_stats.csv"),
    ("16", (0,), "minimd_dragonfly_16_ppn1_nodes16_stats.csv"),
    ("64", (0,), "minimd_dragonfly_64_ppn1_nodes64_stats.csv"),
]
# -------------------------------------------------------------------------
