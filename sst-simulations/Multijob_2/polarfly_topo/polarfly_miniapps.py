...
# PolarFly topology — q=3 gives 13 routers
q = 3
...
total_routers = q*q + q + 1   # = 13 routers
total_nodes   = total_routers * topo.hosts_per_router  # = 26 nodes

topo.hosts_per_router = topo.hosts_per_router
topo.total_routers    = total_routers
topo.total_endnodes   = total_nodes
...
sst.setStatisticOutput("sst.statOutputCSV", {
    "filepath": "polarfly_miniapps_stats.csv",
    "separator": ", "
})
...
print(f"\nTopology: PolarFly q={q}, {total_routers} routers x 2 hosts = {total_nodes} nodes")
