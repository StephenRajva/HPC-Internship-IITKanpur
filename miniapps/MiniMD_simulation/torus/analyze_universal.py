#!/usr/bin/env python3
# =============================================================================
#  analyze_universal.py  -  PPN=1 scaling graphs for ANY topology + app
#
...
STUDY    = "MiniMD_Torus3D"      # used in titles + output filenames
TOPOLOGY = "torus"
# (x-axis label, dims tuple, csv filename)
RUNS = [
    ("2x2x2", (2,2,2), "minimd_torus_2x2x2_ppn1_nodes8_stats.csv"),
    ("2x2x4", (2,2,4), "minimd_torus_2x2x4_ppn1_nodes16_stats.csv"),
    ("4x4x4", (4,4,4), "minimd_torus_4x4x4_ppn1_nodes64_stats.csv"),
    ("4x4x8", (4,4,8), "minimd_torus_4x4x8_ppn1_nodes128_stats.csv"),
    ("8x8x8", (8,8,8), "minimd_torus_8x8x8_ppn1_nodes512_stats.csv"),
]
# -------------------------------------------------------------------------
...
for key, ylabel, short, fmt, color in PLOTS:
    ...
    ax.set_title(f"{STUDY}: {short} vs size  (PPN = 1)")
